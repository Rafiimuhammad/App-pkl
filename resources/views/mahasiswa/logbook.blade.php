        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <div class="card-tools">
                    <a class="btn btn-success" href="/tambahdatalogbook">
                                ...
                                @foreach ($data as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-state">
                                            ...
                                            @elseif($row->status==1) <span class="badge badge-success">Diterima</span>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info btn-sm" href="/tampilkandatalogbook/{{ $row->id }}">
