    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="mb-3">
                    <h1>Data pengajuan Pendaftaran PKL</h1>
                </div>
            </div>
            <!-- /.content-header -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <div class="card-body">
                                    <form action="/validasidatapendaftaranpkl/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        @method('PUT')
                                        ...
                                        <div class="form-group mb-0">
                                            <label for="exampleInputEmail1" class="form-label">File Persyaratan PKL</label>
                                        </div>
                                        <div class="form-group mb-0">
                                ...
                                <div class="card-footer">
                                    <input class="btn btn-success" type="submit" name="submit" value="Validasi">
                                    <a href="/tolakdatapendaftaranpkl/{{$data->id}}" class="btn btn-danger">Tolak</a>
