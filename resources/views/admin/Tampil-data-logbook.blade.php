                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <div class="card-body">
                                    <form action="/validasilogbook/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        @method('PUT')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="dosenpembimbing" class="form-control"
                                                id="exampleInputEmail1" aria-describedby="emailHelp"
                                                placeholder="" value="{{ $data->minggu }}">
                                        </div>
                                        <div class="form-group mb-0">
                                            <label for="exampleInputEmail1" class="form-label">File Logbook</label>
                                        </div>
                                        <div class="form-group mb-0">
                                            <iframe height="500" width="500" src="/filelogbook/{{$data->filelogbook}}"></iframe>
                                        </div>
                                </div>
                                <!-- /.card-body -->
                                <div class="card-footer">
                                    <input class="btn btn-success" type="submit" name="submit" value="Validasi">
                                    {{-- <a href="/tolaklogbookl/{{$data->id}}" class="btn btn-danger">Tolak</a> --}}
