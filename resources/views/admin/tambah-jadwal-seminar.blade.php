            ...
            <section class="content">
                <div class="content">
                    <div class="card card-info card-outline">
                        ...
                        <form action="{{ url('/store-jadwal-seminar/') }}" method="POST" class="card-body row">
                            @csrf
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <h5>Ruangan</h5>
                                <input name="ruangan" type="text" class="form-control" placeholder="Masukkan Ruangan"><br>
                                <h5>Jadwal</h5>
                                <input name="tanggal" type="datetime-local" class="form-control" placeholder="Masukkan Jadwal"><br>
                                <h5>Durasi</h5>
                                <input name="durasi" type="text" class="form-control" placeholder="Masukkan Durasi"><br><br>
